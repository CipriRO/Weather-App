...
function App() {
  ...
  const [notLoadedCurrWeather, setNotLoadedCurrWeather] = useState(false);
  const [notLoadedCurrAstronomy, setNotLoadedCurrAstronomy] = useState(false);
  ...
  useEffect(() => {
    ...
    async function fetchcurrentWeather() {
      try {
        ...
        data && setNotLoadedCurrWeather(false);
      } catch (error) {
    ...
    async function fetchcurrentAstronomy() {
      try {
        ...
        data && setNotLoadedCurrAstronomy(false);
      } catch (error) {
        console.log("Error:", error);
      }
    }
  ...
  return (
    <>
      <SidePanel
        ...
        notLoadedCurrAstronomy={notLoadedCurrAstronomy}
